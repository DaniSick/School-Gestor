<div class="flex h-screen">
    ...
    <div class="flex-1 p-6 overflow-y-auto">
        <div class="bg-gray-200 p-4">
            <h1 class="text-2xl font-bold">Crear Contenedor de Pólizas</h1>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mt-6">
            ...
            <div class="mt-6 flex justify-between items-center">
                <div class="text-center">
                    @if ($lineas->isEmpty())
                        <div class="text-red-600 font-bold">Debe agregar al menos una línea para guardar</div>
                    @elseif ($totalCargos != $totalAbonos)
                        <div class="text-red-600 font-bold">Los totales deben ser iguales para guardar</div>
                    @else
                        <div class="text-green-600 font-bold">¡Listo para guardar!</div>
                    @endif
                </div>
            </div>
        </div>
